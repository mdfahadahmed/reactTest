  ...
  return (
    ...
    <div className="flex justify-between grid-cols-3 mb-8">
      <div className="w-1/3 border-r-2">
         ...
         <p className="font-mono text-base text-white mt-6">I am very sociable and curious. I love discussing ideas and events. Knowing I could share these interests with my Cambly tutors, I don’t remember ever missing a single booked lesson.</p>
      </div>
      ...
      <div className="w-3/12 border-r-2">
        ...
        <ul className="items-center text-white font-bold font-mono text-base capitalize">
          <li className="mb-3 hover:text-[#f68f3d]" href="#">Home</li>
          <li className="mb-3 hover:text-[#f68f3d]" href="#">About</li>
          <li className="mb-3 hover:text-[#f68f3d]" href="#">Profile</li>
          <li className="mb-3 hover:text-[#f68f3d]" href="#">Location</li>
          <li className="mb-3 hover:text-[#f68f3d]" href="#">Contact US</li>
        </ul>
      </div>
